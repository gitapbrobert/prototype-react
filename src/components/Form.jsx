...
import { Form, ButtonToolbar, Button, Input, InputGroup, InputNumber, Modal } from 'rsuite';

const Textarea = React.forwardRef((props, ref) => <Input {...props} as="textarea" ref={ref} />);

const MyForm = (task, taskTypes, onAction) => {
    ...
    console.log("soy u formulario bitches")
    return (
